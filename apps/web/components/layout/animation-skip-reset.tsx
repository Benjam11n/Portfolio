...
export function AnimationSkipReset() {
  ...
  return (
    <Card className="fixed right-4 bottom-4 z-120 hidden items-center gap-2 border-border/60 bg-background/92 p-1 shadow-lg backdrop-blur sm:right-6 sm:bottom-6 sm:flex">
      <div
        aria-hidden="true"
