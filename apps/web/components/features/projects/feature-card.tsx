...
export const FeatureCard = ({ feature, index }: FeatureCardProps) => (
  ...
  >
    <div className="flex items-start gap-4">
      <div className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-secondary font-mono text-[10px] text-muted-foreground ring-1 ring-border/50">
