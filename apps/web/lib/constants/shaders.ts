 ...
 * Dither Fragment Shader
 *
 * Applies Bayer matrix dithering for a retro/pixelated visual effect.
 * This shader is used in conjunction with the post-processing pipeline.
 *
 * Note: This shader currently contains wave animation code (same as wave.frag.glsl).
 * The proper dither implementation with Bayer matrix should be added here.
 *
 * Uniforms:
