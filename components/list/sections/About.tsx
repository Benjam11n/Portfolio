...
const skills: Skill[] = [
  ...
  },
  {
    ...
    size: 'xl',
    icon: (props) => (
      <Image src="/assets/java.svg" alt="Java" width={24} height={24} className={props.className} />
    ),
  },
  {
    name: 'Golang',
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                As a full-stack developer, I combine frontend craftsmanship with backend expertise,
                focusing on integrating AI to build more intelligent and responsive web
                applications.
              </p>
            </div>
          </div>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container relative">
                ...
                >
                  {skills.map((skill, index) => (
                    ...
                    >
                      <div
                        className={cn(
                          sizeClasses[skill.size as 'lg' | 'sm' | 'md' | 'lg' | 'xl'],
                          'flex items-center justify-center rounded-full hover:cursor-grab',
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <p className="grid-subtext">
                I am always learning and improving my skills to keep up with the latest
                technologies.
              </p>
            </div>
          </div>
